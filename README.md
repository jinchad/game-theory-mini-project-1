...
A **"divide and conquer"** algorithm is then used to find the **reasonable Nash Equilibrium** of the binary tree. Finally, the binary tree is shown on a png file output with the reasonable Nash Equilibrium node highlighted in **red**. 
